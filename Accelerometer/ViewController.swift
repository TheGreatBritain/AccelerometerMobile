...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        motionManager.startAccelerometerUpdates(to: .main) { (accelerometerData, error) in
            ...
            // Motion manager start accelerometer function will return the x,y and z axis value details whenever the phone is moved. So the output values will be printed for every minute motion of iPhone. For every small motion they will print 100000 of data values
            ...
            // To minimise the values returned by the acclerometer, using number formatter, which will set fraction value to our desired value.
